...
object PokemonPortraitRenderer {
    ...
    private val logger =
        LoggerFactory.getLogger(
            "battleintroduction/PokemonPortraitRenderer"
        )
...
// keep profile state alive for cobblemon idle anims
    ...
    fun render(
        ...
        return when (
            BattleIntroductionConfig.pokemonPortraitMode
        ) {
            BattleIntroductionConfig.PokemonPortraitMode.DISABLED ->
                false

            BattleIntroductionConfig.PokemonPortraitMode.AUTOMATIC ->
                render3dThen2d(
                    ctx,
                    entity,
                    centerX,
            ...
            BattleIntroductionConfig.PokemonPortraitMode.THREE_D_ONLY ->
                render3dIfAvailable(
                    ctx,
                    entity,
                    centerX,
            ...
            BattleIntroductionConfig.PokemonPortraitMode.TWO_D_PREFERRED ->
                render2dIfAvailable(
                    ctx,
                    entity,
                    centerX,
            ...
            BattleIntroductionConfig.PokemonPortraitMode.TWO_D_ONLY ->
                render2dIfAvailable(
                    ctx,
                    entity,
                    centerX,
