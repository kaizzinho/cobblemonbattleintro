...
object TrainerPortraitRenderer {
    ...
    private val LOGGER = LoggerFactory.getLogger("battleslider/TrainerPortrait")
...
// cache keeps the skin widgets cheap
    ...
    fun render(
        ...
        when (BattleSliderConfig.trainerPortraitMode) {
            BattleSliderConfig.TrainerPortraitMode.DISABLED ->
                return

            BattleSliderConfig.TrainerPortraitMode.TWO_D_ONLY -> {
            ...
            BattleSliderConfig.TrainerPortraitMode.THREE_D_PREFERRED -> {
                if (
                    !render3d(
                        ctx,
                        skinId,
    ...
    private fun render3d(
        ...
        return try {
            ...
            if (BattleSliderConfig.debugLogging && logged3d.add(entity.uuid)) {
